...
<div class="card">
    ...
    <div class="card-body px-5">
        <form action="{{route('roles.store')}}" method="post" id="form-create-rol">
            @csrf
            <div class="form-group mb-3">
                <label for="name-role" class="h3">Nombre</label>
                <input type="text" name="name" id="name-role" placeholder="Ingrese nombre del Rol" class="form-control" required>
            </div>
    ...
    <div class="card-footer ">
        ...
        <button type="submit" class="btn btn-primary" form="form-create-rol">Crear Rol</button>
    </div>
    </div>
</div>
