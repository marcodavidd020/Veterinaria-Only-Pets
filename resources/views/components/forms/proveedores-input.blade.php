        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid bd-example-row">
                    <form class="row g-3" id="formProveedoresInput" action="{{ route('proveedores.store') }}"
                        method="post">
                        @csrf
                        <div class="row mt-2">
                            <div class="col-md-12">
            ...
            <div class="modal-footer">
                ...
                <button type="submmit" form="formProveedoresInput" class="btn btn-danger btn-lg">Añadir</button>
            </div>
        </div>
    </div>
</div>
